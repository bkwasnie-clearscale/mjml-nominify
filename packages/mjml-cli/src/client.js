...
import mjml2html, { components, initializeType } from 'mjml-core-snyk'
import migrate from 'mjml-migrate-snyk'
import validate, { dependencies } from 'mjml-validator-snyk'
import MJMLParser from 'mjml-parser-xml-snyk'

import { version as coreVersion } from 'mjml-core-snyk/package.json'
